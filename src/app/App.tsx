...
function BtnPrimary({
  ...
  const cls =
    "inline-flex items-center justify-center gap-2 px-6 py-4 hover:opacity-85 transition-opacity";
  const style = {
    background: GRN,
    fontFamily: T.mono,
    fontSize: "14px",
...
function BtnOutline({
  ...
  const cls =
    "inline-flex items-center justify-center px-6 py-4 hover:opacity-70 transition-opacity";
  const style = {
    border: `1.5px solid ${GRN}`,
    fontFamily: T.mono,
    fontSize: "14px",
    fontWeight: 500,
    color: GRN
...
function Hero() {
  return (
    <div
      ...
      data-name="Intro + Features section"
    >
      <div
        className="absolute bg-gradient-to-b from-[#a8d3ff] to-[#fff4df] pointer-events-none"
        style={{ inset: "0 0 65.24% 0" }}
      ...
      <header className="relative w-full">
        <div className="flex flex-col items-center w-full">
          <div className="flex flex-col gap-8 items-center pt-44 pb-16 px-6 md:px-10 w-full max-w-6xl mx-auto">
            <motion.div
              className="max-w-2xl w-full flex flex-col items-center gap-6 text-center"
              initial="hidden"
              animate="visible"
              variants={stagger}
            >
              ...
              >
                ...
                websites, marketing, software, and strategy — so you can focus
            ...
            >
              <iframe
                src="https://visiwiseoptimization-us.github.io/Display-dash/"
                className="absolute inset-0 w-full h-full border-none"
                title="VisiWise Dashboard Preview"
                scrolling="no"
              />
            </motion.div>
          </div>
              ...
              {[
                {
                  num: "001",
                  label: "Build",
                  desc: "Custom websites and digital assets designed around how your business actually operates."
                },
                {
                  num: "002",
                  label: "Manage",
                  desc: "Software and infrastructure that keeps your operations organized, fast, and always online."
                },
                {
                  num: "003",
                  label: "Grow",
                  desc: "SEO and marketing campaigns engineered to increase visibility and bring in qualified leads."
                },
                {
                  num: "004",
                  label: "Optimize",
                  desc: "KPI analysis and reporting so every decision is backed by data, not guesswork.",
                  last: true
                }
              ].map((item) => (
                <motion.div
                  ...
                  style={{
                    ...
                    ...(item.last ? { borderBottom: `1px solid ${BDR}` } : {})
                  }}
                >
...
function Pricing() {
  const plans = [
    ...
    },
    {
      ...
      features: [
        "Everything in Basic",
        "Social media posting — 3×/week, 3 platforms",
    ...
    >
      <div className="max-w-6xl mx-auto flex flex-col gap-12">
        ...
        >
          ...
          >
            Website setup · Google Business Profile · Social profile
            optimization · Initial SEO configuration. Scoped and fixed before
                ...
                <div className="flex items-baseline gap-1">
                  ...
                  <span
                    style={{
                      fontFamily: T.mono,
                      fontSize: "13px",
                      color: p.popular ? "rgba(255,255,255,0.55)" : GRY
                    }}
                  >
                    /month
                  </span>
                ...
                {p.features.map((f) => (
                  <li
                    ...
                    style={{
                      fontFamily: T.serif,
                      fontSize: "15px",
                      color: p.popular ? "rgba(255,255,255,0.85)" : GRY,
                      lineHeight: 1.5
                    }}
                  >
                    <span
        ...
        >
          All management plans run on 4-month minimum contracts. After the
          initial term, continue month-to-month or lock in a new term at the
          same rate.
        </motion.p>
      </div>
    </section>
              ...
              >
                ...
                <div className="flex flex-col gap-2 min-w-0 pt-1">
                  ...
                  <div
                    ...
                    style={{ fontFamily: T.mono, fontSize: "13px", color: GRY }}
                  >
                    <span>{a.tag}</span>
                    <span>·</span>
      ...
      <div className="max-w-6xl mx-auto flex flex-col gap-12">
        ...
        >
          ...
          <motion.div variants={fadeUp} className="flex flex-col gap-6">
            ...
            >
              We'll review your current digital presence live — website, SEO,
              social — and walk you through what we'd prioritize. You'll leave
              with clarity whether or not you work with us.
            </p>
            <ul className="flex flex-col gap-3">
              {[
                ...
                >
                  <span style={{ color: GRN, flexShrink: 0, marginTop: "3px" }}>
                    ✦
                  </span>
                  {item}
                </li>
            ...
            <BtnPrimary href={BOOKING_URL}>
              Schedule a Free Audit Call
            </BtnPrimary>
            <div className="flex items-center gap-4">
              <div style={{ flex: 1, height: "1px", background: BDR }} />
              <span
                style={{ fontFamily: T.serif, fontSize: "14px", color: GRY }}
              >
...
function HomePage() {
  useEffect(() => {
    document.title =
      "VisiWise Optimization — Digital Operations, Built for Business";
    ...
    meta.setAttribute(
      "content",
      "VisiWise Optimization helps service businesses grow with full-stack digital marketing, reporting, and software solutions. Start for $299."
    );
  }, []);
